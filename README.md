...
│   ├── b8_q50_r560/          #   560 resolution (8 GB min VRAM)
...
| Resolution | Avg ms/round | Per camera | FPS/cam | Total FPS | VRAM |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 1008 (Q200) | 426 ms | 53 ms | 2.3 | 18.8 | **8,718 MB** |
| 1008 (Q50) | 425 ms | 53 ms | 2.3 | 18.8 | **7,500 MB** |
| 840 | 446 ms | 55.8 ms | 2.2 | 17.9 | **12,909 MB** |
| **672** | **253 ms** | **31.6 ms** | **4.0** | **31.7** | **4,846 MB** |
| **560** | **216 ms** | **27.0 ms** | **4.6** | **37.0** | **4,060 MB** |

> **8 GB deployment**: 672 (4.0 FPS/cam) or 560 (4.6 FPS/cam) recommended.
