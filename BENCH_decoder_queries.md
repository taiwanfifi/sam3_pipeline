...
| 組合 | 8 路 Avg ms | 每路 FPS | Total FPS | Config |
|------|:---:|:---:|:---:|------|
| Q200 @ 1008 | 426 ms | 2.3 | 18.8 | `config.json` |
| Q50 @ 1008 | 425 ms | 2.3 | 18.8 | `config_q50.json` |
| Q50 @ 840 | 446 ms | 2.2 | 17.9 | `config_q50_r840.json` |
| **Q50 @ 672** | **253 ms** | **4.0** | **31.7** | `config_q50_r672.json` |
| **Q50 @ 560** | **147 ms** | **6.8** | **54.3** | `config_q50_r560.json` |
| **Q50 @ 448** | **132 ms** | **7.6** | **60.8** | `config_q50_r448.json` |
