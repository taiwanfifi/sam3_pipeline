...
| **560** | 40 | 3,874 MB | 30.3 ms | 33.0 | 58.5 | 3,923 |
| **448** | 32 | 3,251 MB | 26.1 ms | 38.4 | 50.6 | 4,074 |
...
| **560** | 132.8 ms | 16.6 ms | **7.5** | 60.2 | **~4,060 MB** | 180 ms | 可行（餘 3.9 GB） |
| **448** | 108.6 ms | 13.6 ms | **9.2** | 73.6 | **~3,500 MB** | 153 ms | 可行（餘 4.5 GB） |
...
| **560** | 55% | 206% | 31% | 336% | 大物件 OK |
| **448** | 46% | 240% | 27% | 411% | 近距離大物件 OK |
...
├── b8_q50_r560/     ← 560（8 GB 部署，7.5 FPS/cam @8路）
├── b8_q50_r448/     ← 448（最快最省，9.2 FPS/cam @8路，近距離場景）
